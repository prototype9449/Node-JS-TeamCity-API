...
==================
  ...
  * Fixes mainManager.js failure to close connection after transport error has happened
...
==================
  ...
  * Added http referrer verification to mainManager.js verifyOrigin. [einaors]
