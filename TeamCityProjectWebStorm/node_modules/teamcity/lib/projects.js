(function() {
  module.exports = function(client) {
    ...
    childGetter = function(locator) {
      ...
      return {
        buildTypes: function(cb) {
          return client._get("/app/rest/projects/" + identifier + "/buildTypes", cb);
        },
        templates: function(cb) {
          return client._get("/app/rest/projects/" + identifier + "/templates", cb);
        },
        parameters: function(param, cb) {
          return client._get("/app/rest/projects/" + identifier + "/parameters/" + param, cb);
        }
      };
    };
    getProject = function(locator, cb) {
      var id;
      if (locator.compile) {
        return client._get('/app/rest/projects', {
          locator: locator.compile()
        });
      } else {
        id = locator;
        return client._get("/app/rest/projects/" + id, cb);
      }
    };
